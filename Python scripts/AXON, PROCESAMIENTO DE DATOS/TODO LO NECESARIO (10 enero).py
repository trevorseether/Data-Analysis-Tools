# -*- coding: utf-8 -*-
"""
Created on Wed Dec 18 12:55:06 2024
...
#%%
sub_carpeta  = 'nueva generación de datos'

os.chdir('C:\\Users\\sanmiguel38\\Desktop\\prueba' + '\\' + sub_carpeta)

excel        = '02_Prestamos-16012025.xlsx'
...
###############################################################################
'prmpr'
'EN CASO SE ESTÉ PROCESANDO LA PESTAÑA DE LOS DATOS DE CADA CRÉDITO (prmpr):'
AÑADIR_DIAS_GRACIA = False
###############################################################################
...
columnas_strip = ['direccion', 'Referencia']#['NombreCompleto', 'Apellidopaterno', 'Apellidomaterno', 'PrimerNombre', 'SegundoNombre'] # ['socio', 'DireccionDNI']
...
if activar_limpieza == True:
    columnas_limpiar = ['direccion', 'Referencia']#['NombreCompleto', 'Apellidopaterno', 'Apellidomaterno', 'PrimerNombre', 'SegundoNombre'] # ['socio', 'DireccionDNI']
...
columna = 'indice que debe ser único' # 'NumerodePrestamo' # 'indice que debe ser único'
...
if crear_csv == True:
    ...
    base3.to_csv(nombre_carpeta + '\\' + sheet_nombre + ' (antes de añadir cuota cero).csv', 
                  index    =  False,
