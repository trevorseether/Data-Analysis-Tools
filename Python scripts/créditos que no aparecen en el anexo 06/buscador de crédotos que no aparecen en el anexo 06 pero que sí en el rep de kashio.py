# -*- coding: utf-8 -*-
"""
Created on Fri Oct 27 16:03:46 2023

@author: sanmiguel38
"""

# =============================================================================
# POSIBLES CRÉDITOS de kashio QUE NO APARECEN EN EL ANEXO 06
# =============================================================================
...
#%%
fincore_kashio = pd.read_excel(archivo_excel_kashio,
                               dtype = {'REFERENCIA': str})

fincore_kashio['REFERENCIA'] = fincore_kashio['REFERENCIA'].str.strip()

fincore_kashio.drop_duplicates(subset  = 'REFERENCIA', 
                               inplace = True)

#%%
filas_filtradas = fincore_kashio[~fincore_kashio['REFERENCIA'].isin(base_sql['Nro_Fincore'])]
...
#%% filtramos y ahora sí obtenemos créditos que aparecen en el reporte de kashio pero no en el anexo06
filas_filtradas = filas_filtradas[~filas_filtradas['REFERENCIA'].isin(df_fincore['pagare_fincore'])]
