...
#######################################################
### este reporte ya no lo vamos a mandar a experian ###
#######################################################
#pero posiblemente lo estaremos enviando a control interno
...
#este reporte está mal porque no tenemos situacion_credito en el anexo06, pendiente de modificar
'''
