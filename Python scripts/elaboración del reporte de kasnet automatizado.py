...
#fecha_siguiente_manual = '12/06/2023' #aquí va la fecha de cálculo
#fecha_final_manual = '30/06/2023'     #aquí va la fecha de vigencia
...
url = 'https://stkprod.globokas.com/appgknweb/Login'
...
pyautogui.sleep(3)
#%%%
# a partir de aquí comenzamos con el reporte
#reporte
...
pyautogui.moveTo(320, 50, 0.2, pyautogui.easeInCubic)
pyautogui.doubleClick()
pyautogui.hotkey('ctrl', 'c')

#%%abrimos el excel que vamos a modificar:

ruta_excel = 'C:\\Users\\sanmiguel38\\Desktop\\BATCH KASNET\\abril 2023\\BATCH Kasnet - Archivo Entrada - 27-04-23  7_00pm con cuotas hasta 31-05-23.xlsx'
os.startfile(ruta_excel)
pyautogui.sleep(3)
#maximizamos
pyautogui.hotkey('alt', 'space', 'x')

pyautogui.moveTo(865, 570, 0.2, pyautogui.easeInCubic)
pyautogui.click()
pyautogui.sleep(0.9)
pyautogui.click()
...
pyautogui.moveTo(200, 260, 0.2, pyautogui.easeInCubic)
pyautogui.click()
pyautogui.keyDown('del')
#%%
#pegamos la primera fila del block de notas en excel
pyautogui.moveTo(200, 260, 0.2, pyautogui.easeInCubic)
pyautogui.click()
pyautogui.hotkey('ctrl', 'v')
...
pyautogui.moveTo(320, 50, 0.3, pyautogui.easeInCubic)
pyautogui.doubleClick()
pyautogui.sleep(0.2)
...
pyautogui.moveTo(180, 320, 0.3, pyautogui.easeInCubic)
pyautogui.click()
pyautogui.hotkey('ctrl', 'v')
pyautogui.moveTo(180, 320, 0.3, pyautogui.easeInCubic)
pyautogui.click()
...
#eliminamos toda la columna (N)
pyautogui.moveTo(1800, 210, 0.3, pyautogui.easeInCubic)
pyautogui.click()
pyautogui.sleep(0.1)
pyautogui.keyDown('del') #ELIMINAMOS TODA LA COLUMNA

pyautogui.moveTo(1700, 325, 0.3, pyautogui.easeInCubic)
pyautogui.click()
pyautogui.sleep(0.1)
pyautogui.hotkey('ctrl', 'c') #COPIAMOS LA LETRA R DEL COSTADO
pyautogui.moveTo(1800, 325, 0.3, pyautogui.easeInCubic)
pyautogui.click()
pyautogui.sleep(0.1)
pyautogui.hotkey('ctrl', 'v') #PEGAMOS LA LETRA R A SU COSTADO

pyautogui.moveTo(1740, 350, 0.1, pyautogui.easeInCubic)
pyautogui.click()
pyautogui.write('=SI.ERROR(K5*0.01;"")')
pyautogui.hotkey('enter')

pyautogui.hotkey('up')
pyautogui.moveTo(1842, 355, 0.2, pyautogui.easeInCubic)
pyautogui.doubleClick()
...
pyautogui.moveTo(1600, 258, 0.3, pyautogui.easeInCubic)
pyautogui.click()
pyautogui.sleep(0.2)
pyautogui.hotkey('ctrl', 'c')
pyautogui.moveTo(1600, 240, 0.3, pyautogui.easeInCubic)

#pyautogui.click() #

pyautogui.rightClick()
pyautogui.moveTo(1670,360, 0.3, pyautogui.easeInCubic)
pyautogui.click()

#copiamos el texto para verificar si es Verdadero
pyautogui.moveTo(1600, 240, 0.3, pyautogui.easeInCubic)
pyautogui.click()
pyautogui.sleep(0.2)
pyautogui.click()
