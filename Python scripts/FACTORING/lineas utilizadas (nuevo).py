...
nombre           = 'Rpt_LineaAsignadaXLineaConsumidaXFecha22112024.xlsx'
filas_skip       = 8
tipo_cambio      = 3.792
fecha_corte      = '2024-11-22'
CARGA_SQL_SERVER = True
tabla_nombre     = 'FACTORING.DBO.[LINEAS_20241122_v2]' # le dejé el v2 para diferenciar del modelo anterior 
