...
nombre           = 'Rpt_LineaAsignadaXLineaConsumidaXFecha11112024.xlsx'
filas_skip       = 8
tipo_cambio      = 3.766
fecha_corte      = '2024-11-08'
CARGA_SQL_SERVER = True
tabla_nombre     = 'FACTORING.DBO.[LINEAS_20241108_v2]' # le dejé el v2 para diferenciar del modelo anterior 
