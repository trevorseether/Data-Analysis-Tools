...
#%%
os.chdir('C:\\Users\\sanmiguel38\\Desktop\\envio de correos')

#%%
# Carga tu dataframe (asegúrate de que tiene las columnas 'correo', 'mensaje' y 'asunto')
df = pd.read_excel('Copia de cuentas M365 coopacsanmiguel passwords.xlsx',
                   sheet_name = 'Hoja1',
                   skiprows   = 3,
...
df['asunto'] = 'NUEVO ACCESO DE CORREO COORPORATIVO'
...
<p style="text-align: left;color: rgb(44, 54, 58);background-color: rgb(255, 255, 255);font-size: 14px;font-family: Roboto, sans-serif;">Detallo credenciales de acceso a la nueva plataforma de correo Microsoft, el cual estar&aacute; activo desde el d&iacute;a de hoy viernes 11 desde las 8PM &ldquo;<strong>SOLO PARA USO EN LA WEB MOMENTANEAMENTE&rdquo;</strong>.</p>
    ...
    <tbody>
        <tr>
            ...
            <td valign="bottom" style="border-left: none; border-right: 1pt solid windowtext; border-top: 1pt solid windowtext; border-bottom: 1pt solid windowtext; width: 195px;">
                <p align="center" style="text-align: center;"><span style="color: black;font-size: 12pt;">Link de acceso</span></p>
            </td>
        </tr>
        <tr>
            <td valign="bottom" style="border-left: 1pt solid windowtext; border-right: 1pt solid windowtext; border-top: none; border-bottom: 1pt solid windowtext; width: 231px;">
...
<p style="text-align: left;color: rgb(44, 54, 58);background-color: rgb(255, 255, 255);font-size: 14px;font-family: Roboto, sans-serif;"><strong>A partir de dicha hora (8pm), todo proceso de envio y recepcion de correos ser&aacute; mediante la nueva plataforma v&iacute;a Microsoft.</strong></p>
<p style="text-align: left;color: rgb(44, 54, 58);background-color: rgb(255, 255, 255);font-size: 14px;font-family: Roboto, sans-serif;"><strong>&nbsp;</strong></p>
<p style="text-align: left;color: rgb(44, 54, 58);background-color: rgb(255, 255, 255);font-size: 14px;font-family: Roboto, sans-serif;">NOTA:</p>
...
<p style="text-align: left;color: rgb(44, 54, 58);background-color: rgb(255, 255, 255);font-size: 14px;font-family: Roboto, sans-serif;">2.Los correos antiguos se podr&aacute;n visualizar al 100% entre el d&iacute;a lunes-martes (Seg&uacute;n cantidad de correos almacenados).</p>
<p style="text-align: left;color: rgb(44, 54, 58);background-color: rgb(255, 255, 255);font-size: 14px;font-family: Roboto, sans-serif;">3.Desde el d&iacute;a Lunes 14, el &aacute;rea de TI estar&aacute; realizando la configuraci&oacute;n del Outlook v&iacute;a escritorio de manera progresiva.</p>
<p style="text-align: left;color: rgb(44, 54, 58);background-color: rgb(255, 255, 255);font-size: 14px;font-family: Roboto, sans-serif;">4.En caso de requerimientos espec&iacute;ficos pueden comunicarse con el &aacute;rea de soporte mediante el WhatsApp T.I. 990 324 612.<br><br><br>Atentamente.&nbsp;<br>Subgerencia de T.I. Coopac San Miguel Ltda.</p>
'''
