...
select *
into anexos_riesgos3..cabecera_copia_set2023 ---aqui hay una copia de la cabecera
...
exec [Anexos_Riesgos2].[dbo].[SP_Cabecera] '20231031'  -------en el corte de setiembre ha funcionado, sino hay que abrir y meterlo desde adentro uwu
exec [Anexos_Riesgos2].[dbo].[SP_HELPNRO_CABECERA] '20231031'
-------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------
...
where a.FechaCorte1 = '20230930' -- aqui se pone el de hace 2 meses

--codigo para eliminar si es que hay mes actual y salió mal
delete from Anexos_Riesgos2..Anx06_preliminar 
where FechaCorte1 = '20231031'--AQUI SE PONE EL MES PASADO
...
where c.FechaCorte1 = '20231031' and a.NumerodeCredito18 IS NULL ------SE PONE MES PASADO
...
NUEVA_PLANILLA 
INTO #BASE1
FROM Anexos_Riesgos2..Anx06_preliminar WHERE FechaCorte1 = '20230930' --se pone el de hace 2 meses
...
WHERE A.FechaCorte1 = '20231031' --- SE PONE EL MES PASADO
...
FROM Anexos_Riesgos2..Anx06_preliminar A
WHERE A.FechaCorte1='20231031' AND A.TipodeProducto43=30 AND (A.PLANILLA not LIKE '%LIBRE%'
...
where ccccccccc.FechaCorte1='20231031'
...
FROM Anexos_Riesgos2..Anx06_preliminar A WHERE A.FechaCorte1='20231031' AND A.NUEVO_PROMOTOR is null
...
WHERE A.FechaCorte1='20231031' AND A.NUEVO_PROMOTOR is null
AND A.TipodeProducto43 IN (34,35,36,37,38,39)
...
where c.FechaCorte1='20231031' AND C.NUEVA_PLANILLA IS NULL AND C.TipodeProducto43 IN (34,35,36,37,38,39)
...
from Anexos_Riesgos2..Anx06_preliminar c 
where c.FechaCorte1='20231031' AND C.NUEVA_PLANILLA IS NULL
...
AND a.FechaCorte1 = '20231031' ----------------------AQUI SE PONE EL DE HACE 2 MESES
