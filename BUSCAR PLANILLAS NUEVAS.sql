DECLARE @planilla_TXT  as varchar(255) = '%405%SOCORRO%'
DECLARE @FECHA_CORTE AS DATETIME = '20231231'
...
VALUES (
'UNIDAD EJECUTORA 405 HOSPITAL SANTA MARIA DEL SOCORRO - CAFAE',
'UNIDAD EJECUTORA 405 HOSPITAL SANTA MARIA DEL SOCORRO - CAFAE',
'UNIDAD EJECUTORA 405 HOSPITAL SANTA MARIA DEL SOCORRO',
'UNIDAD EJECUTORA 405 HOSPITAL SANTA MARIA DEL SOCORRO - CAFAE'
        )
		...
		UPDATE Comercial..Anx06
		SET EMPRESA = 'MUNICIPALIDAD DISTRITAL DE SUNAMPE'
		WHERE EMPRESA LIKE '%MUNICIPALIDAD DISTRITAL DE SUNAMPE%'
