...
when c.TipodeCredito19='08' then '3.Créditos a Medianas Empresas'
when c.TipodeCredito19='09' then '2.Créditos a Pequeñas Empresas'
when c.TipodeCredito19='10' then '1.Créditos a Microempresas'
when c.TipodeCredito19='11' then 'Créditos de Consumo Revolventes'
when c.TipodeCredito19='12' then '4.Créditos de Consumo No Revolventes'
when c.TipodeCredito19='13' then '5.Créditos Hipotecarios para Vivienda'
when c.TipodeCredito19='20' then 'Créditos a COOPAC'
end TxtTipoCredito
,sum(Saldodecolocacionescreditosdirectos24)Saldo,count(1) cantidad

from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20250131' and c.Saldodecolocacionescreditosdirectos24>0
group by case 
when c.TipodeCredito19='06' then 'Créditos Corporativos'
when c.TipodeCredito19='07' then 'Créditos a Grandes Empresas'
when c.TipodeCredito19='08' then '3.Créditos a Medianas Empresas'
...
AND UPPER(ISNULL(C.TIPO_afil,'XX')) NOT LIKE '%REF%' AND (C.SITUAC<>'JU' OR C.SITUAC IS NULL)*/
		...
		from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20250131' 
...
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20250131' and 
c.Saldodecolocacionescreditosdirectos24>0
--233
...
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c 
WHERE c.FechaCorte1='20250131' AND 
...
WHERE FechaCorte1 = '20250131'
AND Fecha_castigo = '20250131' ---GENERALMENTE VA A SALIR CERO
--PORQUE LOS CASTIGOS (VENTA DE CARTERA) SON ALGO EXCEPCIONAL
/*
update a
set Fecha_castigo = '20250131'
...
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20250131' AND C.FechaCorte1=EOMONTH(FechadeDesembolso21)  
and c.Saldodecolocacionescreditosdirectos24>0
--233
...
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c 
WHERE c.FechaCorte1='20250131' AND C.FechaCorte1=EOMONTH(FechadeDesembolso21)  
and c.Saldodecolocacionescreditosdirectos24>0
AND TipodeProducto43 IN (34,35,36,37,38,39)
--and UPPER(isnull(TIPO_afil,'XX')) NOT like '%REF%'
AND ISNULL(C.CapitalRefinanciado28,0) = 0
...
--from Cabecera c WHERE c.FechaCorte1='20250131' 
--and c.Saldodecolocacionescreditosdirectos24=0
...
WHERE FechaCorte1 = '20250131'
AND eomonth(Fecha_castigo) = '20250131'
AND TipodeProducto43 IN (34,35,36,37,38,39)
...
select sum(ISNULL(C.MontodeDesembolso22,0)) as 'préstamos en soles'
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20250131' and 
c.Saldodecolocacionescreditosdirectos24>0 and 
C.FechaCorte1=EOMONTH(FechadeDesembolso21) and 
...
select sum(C.MontodeDesembolso22) as 'prestamos en dólares'
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20250131' and 
c.Saldodecolocacionescreditosdirectos24>0 and 
C.FechaCorte1=EOMONTH(FechadeDesembolso21) and 
C.TipodeProducto43 IN (34,35,36,37,38,39) and 
...
/*saldos vigente, refinanciado, judicial, vencido*/
		...
		-- SUMA DEL SALDO DE CARTERA POR TRAMOS (NO SÉ PARA QUÉ EXISTE)
		-- esta vaina no se usa
		/*
		select 
			SUM(C.Saldodecolocacionescreditosdirectos24) as 'Saldo de Colocaciones de creditos directos'
		from 
			ANEXOS_RIESGOS2..ANX06_PRELIMINAR as c 
		WHERE 
			c.FechaCorte1='20250131' and c.Saldodecolocacionescreditosdirectos24>0
		--AND UPPER(ISNULL(C.TIPO_afil,'XX')) NOT LIKE '%REF%' AND (C.SITUAC<>'JU' OR C.SITUAC IS NULL)
			and isnull(c.CapitalRefinanciado28,0) = 0
...
c.Saldodecolocacionescreditosdirectos24>0 and 
C.FechaCorte1=EOMONTH(FechadeDesembolso21) and 
C.TipodeProducto43 IN (34,35,36,38,39) and 
c.Monedadelcredito17='02' 
--AND (UPPER(ISNULL(C.TIPO_afil,'XX')) NOT LIKE '%REF%')
and ISNULL(CapitalRefinanciado28,0) = 0
...
WHERE 
	c.FechaCorte1='20250131' and 
	c.Saldodecolocacionescreditosdirectos24>0  
	AND TipodeProducto43 IN (20,21,23,22,24,25,26,27,28,29)
group by CodigoSocio7,c.Genero4) as a
group by a.Genero4
order by Genero4 desc
...
/*saldos vigente, refinanciado, judicial, vencido*/
		...
		--and c.Saldodecolocacionescreditosdirectos24>0
		--AND UPPER(ISNULL(C.TIPO_afil,'XX')) NOT LIKE '%REF%' AND (C.SITUAC<>'JU' OR C.SITUAC IS NULL)
		AND C.DiasdeMora33>=0  AND TipodeProducto43 IN (20,21,23,22,24,25,26,27,28,29)
		group by CASE
		WHEN C.DiasdeMora33>0 AND C.DiasdeMora33<=30 THEN 'a.[01-30]' 
		WHEN C.DiasdeMora33>30 AND C.DiasdeMora33<=60 THEN 'b.[31-60]'
		WHEN C.DiasdeMora33>60 AND C.DiasdeMora33<=90 THEN 'c.[61-90]'
...
WHERE c.FechaCorte1='20250131' and
 c.Saldodecolocacionescreditosdirectos24>0 AND 
 TipodeProducto43 IN (20,21,23,22,24,25,26,27,28,29) --and UPPER(TIPO_afil) NOT like '%REF%'
--233
...
select sum(ISNULL(C.MontodeDesembolso22,0)) as 'desembolso soles'
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20250131' and 
c.Saldodecolocacionescreditosdirectos24>0 and 
C.FechaCorte1=EOMONTH(FechadeDesembolso21) and 
C.TipodeProducto43 IN (20,21,23,22,24,25,26,27,28,29)
AND c.Monedadelcredito17='01' 
--and UPPER(ISNULL(TIPO_afil,'xx')) NOT like '%REF%'
and ISNULL(CapitalRefinanciado28,0) = 0

select sum(C.MontodeDesembolso22) as 'desembolso dólares'
from Anexos_Riesgos..Cabecera c WHERE c.FechaCorte1='20250131' and 
c.Saldodecolocacionescreditosdirectos24>0 and 
C.FechaCorte1=EOMONTH(FechadeDesembolso21) and 
C.TipodeProducto43 IN (20,21,23,22,24,25,26,27,28,29)
...
select sum(ISNULL(C.MontodeDesembolso22,0)) as 'desembolsos en soles'
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20250131' and 
c.Saldodecolocacionescreditosdirectos24>0 and 
C.FechaCorte1=EOMONTH(FechadeDesembolso21) and 
...
select sum(C.MontodeDesembolso22) as 'desembolsos en dólares'
from Anexos_Riesgos..Cabecera c WHERE c.FechaCorte1='20250131' and 
c.Saldodecolocacionescreditosdirectos24>0 and 
C.FechaCorte1=EOMONTH(FechadeDesembolso21) and 
C.TipodeProducto43 IN (15,16,17,18,19)
...
-----------------nro de créditos desembolsados
select count(Nro_Fincore) AS 'nro desembolsos'
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20250131' 
and c.Saldodecolocacionescreditosdirectos24 > 0 
and C.FechaCorte1=EOMONTH(FechadeDesembolso21) 
and c.TipodeProducto43 IN (95,96,97,98,99)
and ISNULL(CapitalRefinanciado28,0) = 0


-----saldo en monto

select sum(ISNULL(C.MontodeDesembolso22,0)) AS 'DESEMBOLSADO EN SOLES'
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c 
WHERE c.FechaCorte1='20250131' 
and c.Saldodecolocacionescreditosdirectos24 > 0 
and C.FechaCorte1=EOMONTH(FechadeDesembolso21) 
...
select sum(C.MontodeDesembolso22) AS 'DESEMBOLSADO EN DÓLARES'
from anexos_riesgos2..cabecera c 
WHERE c.FechaCorte1='20250131' 
and c.Saldodecolocacionescreditosdirectos24>0 
and C.FechaCorte1=EOMONTH(FechadeDesembolso21) 
and C.TipodeProducto43 IN (95,96,97,98,99)
