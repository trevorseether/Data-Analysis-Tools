...
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20240229' and c.Saldodecolocacionescreditosdirectos24>0
group by case 
when c.TipodeCredito19='06' then 'Créditos Corporativos'
when c.TipodeCredito19='07' then 'Créditos a Grandes Empresas'
when c.TipodeCredito19='08' then 'Créditos a Medianas Empresas'
...
AND UPPER(ISNULL(C.TIPO_afil,'XX')) NOT LIKE '%REF%' AND (C.SITUAC<>'JU' OR C.SITUAC IS NULL)*/
		...
		from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20240229' 
...
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20240229' and 
c.Saldodecolocacionescreditosdirectos24>0
--233
...
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c 
WHERE c.FechaCorte1='20240229' AND 
...
WHERE FechaCorte1 = '20240229'
AND Fecha_castigo = '20240229' ---GENERALMENTE VA A SALIR CERO
--PORQUE LOS CASTIGOS (VENTA DE CARTERA) SON ALGO EXCEPCIONAL
/*
update a
set Fecha_castigo = '20240229'
...
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20240229' AND C.FechaCorte1=EOMONTH(FechadeDesembolso21)  
and c.Saldodecolocacionescreditosdirectos24>0
--233
...
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c 
WHERE c.FechaCorte1='20240229' AND C.FechaCorte1=EOMONTH(FechadeDesembolso21)  
and c.Saldodecolocacionescreditosdirectos24>0
AND TipodeProducto43 IN (34,35,36,37,38,39)
--and UPPER(isnull(TIPO_afil,'XX')) NOT like '%REF%'
AND ISNULL(C.CapitalRefinanciado28,0) = 0
...
--from Cabecera c WHERE c.FechaCorte1='20240229' 
--and c.Saldodecolocacionescreditosdirectos24=0
...
WHERE FechaCorte1 = '20240229'
AND eomonth(Fecha_castigo) = '20240229'
AND TipodeProducto43 IN (34,35,36,37,38,39)
...
select sum(ISNULL(C.MontodeDesembolso22,0)) as 'préstamos en dólares'
from ANEXOS_RIESGOS2..ANX06_PRELIMINAR c WHERE c.FechaCorte1='20240229' and 
c.Saldodecolocacionescreditosdirectos24>0 and 
C.FechaCorte1=EOMONTH(FechadeDesembolso21) and 
...
/*saldos vigente, refinanciado, judicial, vencido*/
		...
		WHERE 
			c.FechaCorte1='20240229' and c.Saldodecolocacionescreditosdirectos24>0
		--AND UPPER(ISNULL(C.TIPO_afil,'XX')) NOT LIKE '%REF%' AND (C.SITUAC<>'JU' OR C.SITUAC IS NULL)
			and isnull(c.CapitalRefinanciado28,0) = 0
...
select sum(C.MontodeDesembolso22)
from Anexos_Riesgos..Cabecera c WHERE c.FechaCorte1='20240229' and 
c.Saldodecolocacionescreditosdirectos24>0 and 
C.FechaCorte1=EOMONTH(FechadeDesembolso21) and 
C.TipodeProducto43 IN (20,21,23,22,24,25,26,27,28,29)
...
from anexos_riesgos2..cabecera c WHERE c.FechaCorte1='20240229' and 
c.Saldodecolocacionescreditosdirectos24>0 and 
C.FechaCorte1=EOMONTH(FechadeDesembolso21) and 
C.TipodeProducto43 IN (95,96,97,98,99)
and c.Monedadelcredito17='02' 
