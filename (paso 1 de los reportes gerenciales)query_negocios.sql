...
--drop table anexos_riesgos3.[dbo].[cabecera_copia_oct2023]
select *
into anexos_riesgos3..cabecera_copia_enero2025 ---aqui hay una copia de la cabecera
...
--from anexos_riesgos2..cabecera_copia_junio2023
...
-- hay que modificar este procedimiento almacenado SIEMPRE [SP_Cabecera]
exec [Anexos_Riesgos2].[dbo].[SP_Cabecera] '20250228'  ---- en el corte de setiembre ha funcionado, sino hay que abrir y meterlo desde adentro uwu
exec [Anexos_Riesgos2].[dbo].[SP_HELPNRO_CABECERA] '20250228'
-------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------
...
where a.FechaCorte1 = '20250131' -- aqui se pone el de hace 2 meses

--codigo para eliminar si es que hay mes actual y salió mal
delete from Anexos_Riesgos2..Anx06_preliminar 
where FechaCorte1 = '20250228'--AQUI SE PONE EL MES PASADO
...
where c.FechaCorte1 = '20250228' and a.NumerodeCredito18 IS NULL ------SE PONE MES PASADO
...
NUEVA_PLANILLA 
INTO #BASE1
FROM Anexos_Riesgos2..Anx06_preliminar WHERE FechaCorte1 = '20250131' --se pone el de hace 2 meses
...
WHERE A.FechaCorte1 = '20250228' --- SE PONE EL MES PASADO
...
FROM Anexos_Riesgos2..Anx06_preliminar A WHERE A.FechaCorte1='20250228' AND A.NUEVO_PROMOTOR is null
AND A.TipodeProducto43 IN (34,35,36,37,38,39,51) AND PROMOTOR LIKE '%PROSEVA%'
...
WHERE A.FechaCorte1='20250228' AND A.NUEVO_PROMOTOR is null
AND A.TipodeProducto43 IN (34,35,36,37,38,39,51)
...
where c.FechaCorte1='20250228' AND C.NUEVA_PLANILLA IS NULL AND C.TipodeProducto43 IN (34,35,36,37,38,39,51)
...
from Anexos_Riesgos2..Anx06_preliminar c 
where c.FechaCorte1='20250228' AND C.NUEVA_PLANILLA IS NULL
...
from Anexos_Riesgos2..Anx06_preliminar c where C.FechaCorte1='20250228' 
...
AND a.FechaCorte1 = '20250228' ----------------------AQUI SE PONE EL DE HACE 2 MESES
...
AND A.FechaCorte1 = '20250228'
AND B.FechaCorte1 = '20250228'
AND A.TipodeProducto43 IN (34,35,36,37,38,39,51)
------------------------------------------------------------------------------
update A ---------QUE ESTA PARTE ESTÉ EN PRUEBAS
set A.EMPRESA = B.EMPRESA
...
------QUERY EN CASO DE QUE DEBAMOS ACTUALIZAR EL FUNCIONARIO ADMINISTRADOR PORQUE HUBO REASIGNACIÓN

UPDATE anexos_riesgos2..Anx06_preliminar
SET ADMINISTRADOR = [Funcionario Actual]
where FechaCorte1 = '20250228'
and  nro_fincore in (
