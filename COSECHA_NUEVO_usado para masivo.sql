--------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------
-----------------------PARA AÑADIR LO QUE FALTA AL REPORTE DE FINANZAS..cosecha_nuevo-------
--------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------
...
drop table FINANZAS..cosecha_nuevo

select * 
into FINANZAS..cosecha_nuevo
from FINANZAS..ANX06 where FechaCorte1 >= '20190101'

update FINANZAS..cosecha_nuevo ----esta parte creo que no hace falta ejecutarla, (investigar si hace falta recuperar los castigados incluyendo los vendidos)
set MCastigadoxM = 0 ---
--    [DESEMBOLSO_AGREGADO]
...
----------------------------------------------------------------------------------------------------
/*
alter table FINANZAS..cosecha_nuevo
add desembolso_para_filtros numeric(16,4)
go

update FINANZAS..cosecha_nuevo
...
set @fechaactual = '20190228' ---- hay que añadir los datos desde adelante hasta atrás, por un año
...
/*
INSERT INTO FINANZAS..cosecha_nuevo (
FechadeDesembolso21,
NRO_FINCORE,
MCastigadoxM,
FechaCorte1,
