...
WHERE FECHACORTE1 = '20241130' -------<-------<-------<-------<-----<-----<--CAMBIAR ESTOOOOOO <------------------
...
FROM anexos_riesgos3..Anx06   WHERE FechaCorte1 >= '20230930'  -----<----<----<<---- asegurarse de que ya hay datos actuales en esta tabla
